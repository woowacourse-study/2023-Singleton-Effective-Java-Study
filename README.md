...
- [x]  [item 1. 생성자 대신 정적 팩터리 메서드(static factory method)를 고려하라](2장/item_01) (에코)
- [x]  [item 2. 생성자에 매개변수가 많다면 빌더를 고려하라](2장/item_02) (블랙켓)
- [ ]  item 3. private 생성자나 열거 타입으로 싱글턴임을 보증하라
- [x]  [item 4. 인스턴스화를 막으려거든 private 생성자를 사용하라](2장/item_04) (키아라)
- [x]  [item 5. 자원을 직접 명시하지 말고 의존 객체 주입을 사용하라](2장/item_05) (콩하나)
...
- [x]  [item 12. toString을 항상 재정의하라](3장/item_12) (그레e)
- [ ]  item 13. clone 재정의는 주의해서 진행하라
- [x]  [item 14. Comparable을 구현할지 고려하라](3장/item_14) (호e)
...
- [x]  [item 29. 이왕이면 제네릭 타입으로 만들라](5장/item_29) (져니)
...
- [x]  [item 50. 적시에 방어적 복사본을 만들라](8장/item_50) (푸우)
